...
namespace WorkingWithStreams
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // WorkWithXml();
            // WorkWithCompression();
            WorkWithCompressionImproved();
            WorkWithCompressionImproved(useBrotli: false);
        }
        ...
        static void WorkWithXml()
        {
            ...
            // see page 314 on how to use "using" instead of try-catch-finally
        ...
        static void WorkWithCompressionImproved(bool useBrotli = true)
        {
